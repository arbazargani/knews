 ...
 * Generated for Laravel 5.3.31 on 2022-01-16 17:35:00.
 *
...
namespace Morilog\Jalali\Facades { 
    ...
    class jDateTime {
        ...
        {
            return \Morilog\Jalali\jDateTime::toJalali($gy, $gm, $gd);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::toGregorian($jy, $jm, $jd);
        }
         ...
         * @param int $jm
         * @param int $jd
         * @return \Morilog\Jalali\Gregorian DateTime
         * @static 
         */ 
        public static function toGregorianDate($jy, $jm, $jd)
        {
            return \Morilog\Jalali\jDateTime::toGregorianDate($jy, $jm, $jd);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::isValidateJalaliDate($jy, $jm, $jd);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::checkDate($year, $month, $day, $isJalali);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::isLeapJalaliYear($jy);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::jalaliMonthLength($jy, $jm);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::jalaliCal($jy);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::div($a, $b);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::mod($a, $b);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::d2g($jdn);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::g2d($gy, $gm, $gd);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::j2d($jy, $jm, $jd);
        }
         ...
         * @return array 0: Jalaali year (1 to 3100)
        ...
        {
            return \Morilog\Jalali\jDateTime::d2j($jdn);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::date($format, $stamp, $timezone);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::strftime($format, $stamp, $timezone);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::parseFromFormat($format, $date);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::createDatetimeFromFormat($format, $str, $timezone);
        }
         ...
         * @param $str
         * @param null $timezone
         * @return \Morilog\Jalali\Carbon 
         * @static 
         */ 
        public static function createCarbonFromFormat($format, $str, $timezone = null)
        {
            return \Morilog\Jalali\jDateTime::createCarbonFromFormat($format, $str, $timezone);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::convertNumbers($string);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::createDateTime($timestamp, $timezone);
        }
        ...
        {
            return \Morilog\Jalali\jDateTime::createTimeZone($timezone);
        }
