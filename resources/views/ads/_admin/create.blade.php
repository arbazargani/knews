...
@section('content')
	<h3 class="page-title"> ثبت تبلیغ  جدید:
		<small>از طریق فرم زیر اقدام به تعریف تبلیغ  جدید نمایید.</small>
	</h3>

	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption font-green-haze">
				<i class="icon-settings font-green-haze"></i> <span class="caption-subject bold uppercase"> ثبت تبلیغ  جدید</span>
			</div>
			<div class="actions">
				<div class="btn-group">
				...
				<a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;" title="تمام صفحه"> </a> <a class="btn btn-circle btn-icon-only btn-default tooltips" href="{{ route('admin.ads.index') }}" title="بازگشت" > <i class="fa fa-arrow-left"></i> </a>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-md-9">
							...
							<div class="form-group">
								...
								<div class="input-icon">
									<i class="fa fa-bell-o"></i> <input style="direction: ltr" type="text" value=""
						...
						<div class="col-md-3">
							...
							{{--@include('partials.date',['field_title' => 'تاریخ درج تبلیغ ', 'field_name' => 'date1' , 'data'=> jdate()->format('Y/m/d H:i:s') ,'star'=>true])--}}
							{{--@include('partials.date',['field_title' => 'تاریخ اتمام نمایش تبلیغ ', 'field_name' => 'date2' , 'data'=> jdate()->format('Y/m/d H:i:s') ,'star'=>true])--}}
					...
					<script>
						$(document).ready(function(){
							$('.btnFromSave').click(function () {
								...
								$.post('{{ route('admin.ads.store') }}', $form.serialize(), function (data) {
									if (data.ok) {
