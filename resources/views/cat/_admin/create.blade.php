...
@section('page-bar')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ route('admin.cat.index' , [$module_name]) }}">لیست دسته بندی ها</a> <i class="fa fa-angle-double-left"></i>
        </li>
        <li>
    ...
    <div class="page-toolbar">
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
                <li>
                    <a href="{{ route('admin.cat.index', [$module_name]) }}"> <i class="fa fa-check"></i> لیست دسته بندی ها</a>
                </li>
            </ul>
        </div>
    </div>
...
@section('content')
    <h3 class="page-title">ثبت دسته بندی جدید :
        <small>از طریق فرم زیر اقدام به تعریف دسته بندی جدید  نمایید.</small>
    </h3>

    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-green-haze">
                <i class="icon-settings font-green-haze"></i> <span class="caption-subject bold uppercase"> ثبت دسته بندی جدید</span>
            </div>
            <div class="actions">
                <div class="btn-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            <i class="fa fa-question"></i> <input type="text" class="form-control" name="txtTitel"
                                                                                  id="input_title">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2" style="display: none">
                                    <div class="form-group">
                                       ...
                                       نحوه ی نمایش :
                                        ...
                                        <div class="input-icon">
                                            <i class="fa fa-question"></i>
                                            <select class="form-control" name="typeshow" id="typeshow">
                                                <option value="multiple" selected>آرشیوی</option>
                                                <option value="single">تک پستی</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-md-2"  style="display: none" @if($module_name == 'course' || $module_name == 'products' ) style="display: none" @endif >
                                    <div class="form-group">
                    ...
                    <script>
                        $(document).ready(function(){
                            ...
                            $('.btnFromSave').click(function () {
                                ...
                                $.post('{{ route('admin.cat.store', [$module_name]) }}', $form.serialize(), function (data) {
                                    if (data.ok) {
                                        window.location.replace('{{ route('admin.cat.index', [$module_name]) }}');
                                    } else {
