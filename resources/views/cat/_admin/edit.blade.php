                        ...
                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <select class="form-control" name="typeshow" id="typeshow">
                                                <option value="multiple">آرشیوی</option>
                            ...
                            <script type="application/javascript">
                                $(document).ready(function() {
                                    ...
                                    $('#typeshow').val('{{ $news_cat->type_show }}');
                    ...
                    <script>
                        $(document).ready(function(){
                            ...
                            $('.btnFromSave').click(function () {
                                ...
                                $.post('{{ route('admin.cat.update',[$module_name]) }}', $form.serialize(), function (data) {
                                    if (data.ok) {
