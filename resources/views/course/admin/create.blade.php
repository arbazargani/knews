...
@section('content')
    <h3 class="page-title"> ثبت درس جدید:
        <small>از طریق فرم زیر اقدام به تعریف درس جدید نمایید.</small>
    </h3>

    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-green-haze">
                <i class="icon-settings font-green-haze"></i> <span class="caption-subject bold uppercase"> ثبت درس جدید</span>
            </div>
            <div class="actions">
                <div class="btn-group">
