    ...
    <div class="page-toolbar">
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
                <li>
                    <a href="{{ route('admin.course.create') }}"> <i class="icon-user"></i> ثبت مطلب جدید</a>
                </li>
                <li class="divider"></li>
                <li>
                    <a href="{{ route('admin.course.index') }}"> <i class="icon-bell"></i> لیست مطالب ارسالی</a>
                </li>
            ...
            toolbar: [
                {
                    ...
                    handler: function () {
                        ...
                        if (row) {
                            window.location.href = '{{ route('admin.course.edit','') }}/' + row.id;
                        }
                        else {
                        ...
                        if (row) {
                            $.messager.confirm('توجه', ' آیا از حذف این مطلب مطمئن  هستید؟ ', function (r) {
                                if (r) {
                                    ...
                                    $.post('{{ route('admin.course.delete') }}', params, function (data) {
                                        if (data.ok)
                                            dg.datagrid('reload');
                                        else
