...
@section('title', trans('custom.your_sale') )
    ...
    <div class="account-account">
        <div id="content" class="col-sm-9">
            <div class="row">
                ...
                <div id="content" class="col-sm-12"> <h1>@lang('custom.your_sale')</h1>
                    ...
                    <script>
                        $(function () {
                            var dg = $('#grid1').datagrid({
                                ...
                                height: 450,
                                width: '100%',
                                title: '@lang('custom.your_sale')',
                                sortOrder: 'asc',
                                url: '{{ route('products.sale.list.post') }}',
                                columns: [
                                    [
