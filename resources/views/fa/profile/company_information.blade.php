    ...
    <div class="account-account">
        <div id="content" class="col-sm-9">
            <div class="row">
                ...
                <div id="content" class="col-sm-12"> <h1>@lang('custom.company_information')</h1>
                    <form action="{{ route('profile.company.edit.post',['id'=> $user_companies[0]->id ]) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        {{ csrf_field() }}
                        ...
                        <fieldset id="address">
                            ...
                            <div class="form-group required {{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="company" value="{{ $user_companies[0]->company_name }}" placeholder="@lang('auth.name') @lang('auth.company')" id="input-company" class="form-control">
                            ...
                            <div class="form-group required {{ $errors->has('brand') ? ' has-error' : '' }}">
                                <label class="col-sm-2 control-label" for="input-company">@lang('custom.brand')</label>
                                <div class="col-sm-10">
                                    <input type="text" name="company" value="{{ $user_companies[0]->brand }}" placeholder="@lang('custom.brand')" id="input-company" class="form-control">
                                    @if ($errors->has('brand'))
                                        <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="address" value="{{ $user_companies[0]->company_addr }}" placeholder="@lang('auth.address') @lang('auth.company')" id="input-address" class="form-control">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div id="sbHolder_89706793" class="sbHolder"><a id="sbToggle_89706793" href="#" class="sbToggle"></a>
                                        <select name="zone" id="sbOptions_89706793" class="sbOptions">
                                            ...
                                            <option value="1">آدربایجان غربی</option>
                                            <option value="1">آدربایجان شرقی</option>
                                            <option value="2" selected="selected">تهران</option>
                            ...
                            <div class="form-group required{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="city" value="{{ $user_companies[0]->city }}" placeholder="@lang('auth.city')" id="input-city" class="form-control">
                                    @if ($errors->has('city'))
                                        <span class="help-block">
                            ...
                            <div class="form-group required{{ $errors->has('postcode') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="postcode" value="{{$user_companies[0]->postcode }}" placeholder="@lang('auth.postcode') @lang('auth.city')" id="input-postcode" class="form-control">
                            ...
                            <div class="form-group required{{ $errors->has('tel') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="tel" value="{{ $user_companies[0]->tel }}" placeholder="@lang('auth.tel')" id="input-tel" class="form-control">
                                    @if ($errors->has('tel'))
                                        <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="fax" value="{{ $user_companies[0]->fax }}" placeholder="@lang('auth.fax')" id="input-fax" class="form-control">
                                </div>
                            </div>
                        </fieldset>
