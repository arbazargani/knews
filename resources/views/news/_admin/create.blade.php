...
@section('content')
    <h3 class="page-title"> ثبت خبر جدید:
        <small>از طریق فرم زیر اقدام به تعریف خبر جدید نمایید.</small>
    </h3>
                ...
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="input_summary"> خلاصه متن :</label>
                                <div class="input-icon">
                        ...
                        <div class="col-md-3">
                            ...
                            @include('partials.date',['field_title' => 'تاریخ درج خبر ', 'field_name' => 'date' , 'data'=> jdate()->format('Y/m/d H:i:s') ,'star'=>true])
                        ...
                        <script>
                            $(document).ready(function () {
                                $('.btnFromSave').click(function () {
                                    ...
                                    $.post('{{ route('admin.news.store') }}', $form.serialize(), function (data) {
                                        if (data.ok) {
