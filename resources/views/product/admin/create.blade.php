...
@section('content')
    <h3 class="page-title"> ثبت مطلب جدید:
        <small>از طریق فرم زیر اقدام به تعریف مطلب جدید نمایید.</small>
    </h3>

    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-green-haze">
                <i class="icon-settings font-green-haze"></i> <span class="caption-subject bold uppercase"> ثبت مطلب جدید</span>
            </div>
            <div class="actions">
                <div class="btn-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <i class="fa fa-question"></i> <input type="text" class="form-control" name="title"
                                                                          id="title">
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-12 upbox-vid" style="margin-top:20px "></div>
	...
	<embed width="450" height="350" type="application/x-shockwave-flash" id="player2" name="player2" src="' + base_url + 'assets/media/player.swf" allowscriptaccess="always" allowfullscreen="true" flashvars="file=' + base_url + file.url + '?mode=player&amp;type=video&amp;logo=' + base_url + 'assets/media/logo.png&amp;image=/pages/">\
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-12 upbox-audio" style="margin-top:20px "></div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <input type="hidden" id="filesUrl" name="filesUrl" value="">
                                <div class="col-md-12 upbox-files" style="margin-top:20px ; margin-right: 20px "></div>

                                @push('script')
                                <script>
                                    $(document).ready(function () {
                                        $('body').on('click', '.del_doc', function () {
                                            $('.del_doc').parent().remove();
                                        });
                                    ...
                                    function processFilesDoc(file) {
                                        jQuery.each(file, function (index, item) {
                                            ...
                                            if (typefile == 'doc' || typefile == 'docx' || typefile == 'pdf' || typefile == 'zip' || typefile == 'rar') {
                                                ...
                                                sp = sp.split('/');
                                                spl = sp.length;
                                                $('.upbox-files').append('<li style="margin-bottom: 5px;"><a style="width: 10%; height: 10%;" snattr="' + item.url + '" href="' + base_url + item.url + '" >' + decodeURI(sp[spl - 1]) + '</a><i class="icon-close del_doc" style="cursor: pointer; padding: 7px;"></i></li>');
                                            }
                                            else {
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @include('partials.text' , ['field_title' =>  'قیمت'.' ( ریال ) ' ,'field_name' => 'prices','star'=>true , 'data'=>0])
