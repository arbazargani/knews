...
@section('content')
    <h3 class="page-title">ویرایش مطلب:
        <small>از طریق فرم زیر اقدام به ویرایش مطلب نمایید.</small>
    </h3>
        ...
        <div class="portlet-title">
            <div class="caption font-green-haze">
                <i class="icon-settings font-green-haze"></i> <span
                        class="caption-subject bold uppercase">ویرایش مطلب </span>
            </div>
            <div class="actions">
                <div class="btn-group">
                    ...
                    <script>
                        $(document).ready(function () {
                            $('.btnFromSave').click(function () {
                                ...
                                if (img == '{}')
                                    img = '';
                                $.post('{{ route('admin.products.store.edit') }}',
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <i class="fa fa-question"></i> <input type="text" value="{{ $product->title }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <textarea name="descr" id="descr" cols="30" rows="5"
                                              class="form-control">{{ $product->descr }}</textarea>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="input_text"><span class="text-danger">*</span>
                                    متن:</label> <textarea class="ckeditor form-control" name="text" id="input_text"
                                                           rows="6">{{ $product->fulltext }}</textarea>
                                @push('script_lib')
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-12 upbox-thumb"
                                     ...
                                     data-update=""
                                     data-posturl="">
                                    @foreach( json_decode($product->imgs , true) as $key=>$val )
                            ...
                            <div class="form-group clearfix">
                                ...
                                <input type="hidden" id="videoUrl" name="videoUrl" value="{{ $product->video }}">
	...
	<embed width="450" height="350" type="application/x-shockwave-flash" id="player2" name="player2" src="' + base_url + 'assets/media/player.swf" allowscriptaccess="always" allowfullscreen="true" flashvars="file=' + base_url + file.url + '?mode=player&amp;type=video&amp;logo=' + base_url + 'assets/media/logo.png&amp;image=/pages/">\
                            ...
                            <div class="form-group clearfix">
                                ...
                                <input type="hidden" id="audioUrl" name="audioUrl" value="{{ $product->audio }}">
                                <div class="col-md-12 upbox-audio" style="margin-top:20px ">
                                    @if(!empty($product->audio))
                            ...
                            <div class="form-group clearfix">
                                ...
                                <input type="hidden" id="filesUrl" name="filesUrl" value="{{ $product->files }}">
                                <div class="col-md-12 upbox-files" style="margin-top:20px ; margin-right: 20px ">
                                    @if(!empty($product->files))
                                        @foreach( json_decode($product->files , true) as $val )
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                ...
                                                $('#show_last').val('{{ $product->show_last }}');
                                                $("#type").val([{!! $product->cats !!}]).trigger("change");
                                    ...
                                    @include('partials.text' , ['field_title' =>  'قیمت'.' ( ریال ) ' , 'field_name' => 'prices','star'=>true , 'data'=>$product->price])
