...
@section('content')
    <h3 class="page-title"> ویرایش صفحه:
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-green-haze">
                <i class="icon-settings font-green-haze"></i> <span class="caption-subject bold uppercase"> ویرایش صفحه</span>
            </div>
            <div class="actions">
                <div class="btn-group">
        ...
        <div class="portlet-body form">
            <form id="frm1" role="form" method="POST" autocomplete="off">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <i class="fa fa-bell-o"></i> <input type="text" value="{{ $news->title }}" class="form-control" name="title" id="input_title">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <i class="fa fa-bell-o"></i> <textarea class="form-control" name="summary" id="input_summary" rows="3">{{ $news->descr }}</textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label" for="input_text"><span class="text-danger">*</span> متن:</label> <textarea class="ckeditor form-control" name="text" id="input_text" rows="6">{{ $news->full_text }}</textarea>
                                @push('script_lib')
                                        ...
                                        <div class="input-group input-group-fixed">
                                            ...
                                            <div class="msg">
                                                @if( !empty($news->image_url) )
                                                    <img style="padding: 10px; border: 1px solid lightslategray; margin: 7px; width: 40%;" src="{{ url('files/'.$news->image_url ) }}" alt="">
                                                @endif
                                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <select name="tags[]" id="input_tags" class="form-control" multiple>
                                    @if(!empty($news->tags))
                                        @foreach(\App\Tag::whereIn('id',explode(',',$news->tags)) as $key => $value)
                ...
                <div class="form-actions">
                    ...
                    <script>
                        $(document).ready(function(){
                            $('#show_part').val('{{ $news->show_part }}');
                            $('#sub_cat').val('{{ $news->cats }}');
                            ...
                            $('.btnFromSave').click(function () {
                                ...
                                $.post('{{ route('admin.staticpage.update') }}', $form.serialize(), function (data) {
                                    if (data.ok) {
