...
@section('content')
    <h3 class="page-title"> ویرایش تگ :
        <small>از طریق فرم زیر اقدام به ویرایش تگ نمایید.</small>
    </h3>
        ...
        <div class="portlet-title">
            <div class="caption font-green-haze">
                <i class="icon-settings font-green-haze"></i> <span
                        class="caption-subject bold uppercase"> ویرایش تگ </span>
            </div>
            <div class="actions">
                <div class="btn-group">
                ...
                <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;"
                   title="تمام صفحه"> </a> <a class="btn btn-circle btn-icon-only btn-default tooltips"
                                              href="{{ route('admin.tag.index') }}" title="بازگشت"> <i
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <i class="fa fa-bell-o"></i> <input type="text" value="{{ $tag->title }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <i class="fa fa-bell-o"></i> <input type="text" class="form-control" name="order" value="{{ $tag->order }}" id="input_order">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <script>
                            $(document).ready(function () {
                                ...
                                $('.btnFromSave').click(function () {
                                    ...
                                    $.post('{{ route('admin.tag.update') }}', $form.serialize(), function (data) {
                                        if (data.ok) {
