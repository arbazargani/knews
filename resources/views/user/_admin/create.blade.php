									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="input-icon">
													...
													<input type="text" class="form-control" name="fname" id="input_fname">
												</div>
											</div>
										</div>
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="input-icon">
													<i class="fa fa-bell-o"></i>
													<input type="text" class="form-control" name="lname" id="input_lname">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="input-icon">
													<i class="fa fa-bell-o"></i>
													<input type="text" class="form-control" name="username" id="input_username" placeholder="a-z 0-9 . _ -" dir="ltr">
												</div>
											</div>
										</div>
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="input-icon">
													<i class="fa fa-bell-o"></i>
													<input type="text" class="form-control" name="email" id="input_email" placeholder="sample@email.com" dir="ltr">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-icon">
                                                    <i class="fa fa-bell-o"></i>
                                                    <input type="text" class="form-control" name="mobile" id="input_mobile">
                                                </div>
                                            </div>
                                        </div>
									</div>
							...
							<script>
								$(document).ready(function () {
									$('.btnFromSave').click(function () {
										...
										$.post('{{ route('admin.users.store') }}', $form.serialize(), function (data) {
											if (data.ok) {
