...
@section('content')
    <h3 class="page-title"> ثبت نقش جدید:
        <small>از طریق فرم زیر میتوانید نقش جدیدی به سیستم اضافه نمایید</small>
    </h3>
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn btn-circle btn-icon-only btn-default tooltips" href="{{ route('admin.user.role.index') }}" title="بازگشت"> <i class="fa fa-arrow-left"></i> </a>
            </div>
        </div>
        <div class="portlet-body form">
            <form id="frm1" role="form" method="POST" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <i class="fa fa-bell-o"></i> <input type="number" class="form-control" name="level" id="input_level" min="10" max="99" value="50">
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach($dirs as $dir)
                                    <div class="form-group">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="dirs[{{ $dir }}][r]"> <i aria-hidden="true" class="fa fa-eye"></i>
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="dirs[{{ $dir }}][w]"> <i aria-hidden="true" class="fa fa-edit"></i>
                                        </label>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('admin.user.role.index') }}" class="btn default"><i class="fa fa-arrow-left"></i>انصراف</a>
                    ...
                    <script>
                        $(document).ready(function () {
                            $('.btnFromSave').click(function () {
                                ...
                                $.post('{{ route('admin.user.role.store') }}', $form.serialize(), function (data) {
                                    if (data.ok) {
                                        window.location.replace('{{ route('admin.user.role.index') }}');
                                    } else {
